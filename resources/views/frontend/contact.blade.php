<section id="contact" class="contact-section py-5">
    <div class="container">
            ...
            <div class="col-md-6 mb-3">
                <div class="card h-100 border-0" style="background-color: var(--color-bg-tertiaire);">
                    <div class="card-body d-flex flex-column">
                        ...
                        <h4 class="text_color mb-1">Contactez-moi</h4>
                        <span class="contact-underline mb-2"></span>
                        ...
                        <div class="d-flex align-items-center mb-3">
                            <div
                                class="contact_card_icon rounded-2 d-flex align-items-center justify-content-center me-3">
                                <i class="fas fa-envelope text-white"></i>
                            </div>
                            <div>
                                <h6 class="fw-bold text-white">Email</h6>
                                <a href="mailto:ramananathumingthierry@gmail.com" class="text-white-50">
                        ...
                        <div class="mt-auto border border-danger rounded-2 p-3">
                            ...
                            <p class="mb-2 text-white-50">Je suis actuellement disponible pour discuter de votre projet.
                            </p>
        ...
        <!-- Map -->
        <div class="col-12">
            <x-maps-google :markers="[['lat' => -18.928512395352502, 'long' => 47.560960775006436]]" :centerToBoundsCenter="true" :zoomLevel="14" class="rounded-1 shadow-sm"
                style="width: 100%; height: 400px;"></x-maps-google>
        </div>
    </div>
</section>
